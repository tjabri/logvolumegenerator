...
pub fn test_correct_duration_with_valid_params() {
    ...
    assert_eq!(result, Ok(Duration::from_secs_f64(1f64/((200f64/125f64)/100f64))) )
}
...
pub fn test_correct_duration_with_invalid_params() {
    ...
    for (out_bytes, out_secs, entry_bytes) in cases {
        let result = logvolumegenerator::calculate_iteration_pause(out_bytes,out_secs,entry_bytes);
